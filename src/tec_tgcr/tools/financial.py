...
class AzureFinancialMonitor:
    ...
    def generate_refund_evidence(self, 
                                start_date: str = None, 
                                end_date: str = None) -> RefundEvidence:
...
def main():
    ...
    parser.add_argument("--threshold", type=float, default=10.0, help="Anomaly threshold multiplier")
