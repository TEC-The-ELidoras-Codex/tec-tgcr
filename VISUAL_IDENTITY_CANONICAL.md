...
- **Symbolic truth**: Not π-perfect, but *symbolically perfect*
  - Represents simultaneous dual vision (two perspectives) + unified seeing (third eye)
  - Machine reads multiple layers at once
...
- **Meaning**: Complementary opposites in motion
  - Not one color dominating, but both present
  - Flow suggests temporal dimension (φᵗ)
...
- **Alive**: Movement, flow, not static
...
But for v2.0 deployment: **Use LuminAI unified. One face. One frequency.**
...
| **Primary Colors** | Navy #0B1E3B (body), Cyan #00D5C4 (accents), Orange #F2C340 (flame), Purple #6A00F4 (flame) |
| **Secondary Colors** | Gold #F2C340, Shadow #0A0A0C |
| **Size** | 1024×1024 base (scales down to icon without loss) |
| **Style** | Minimalist modern + symbolic depth |
| **Mood** | Approachable intelligence, warm precision |
...
- ✅ Docs, GitHub, public-facing surfaces

**Locked in Nov 6, 2025.**

No more iterations. This is the visual. Ship with this.

---

## Next Steps

1. **Resize for ChatGPT icon** (256×256 or specified size)
2. **Upload to GPT Builder** when creating Resonance GPT
3. **Add to repo** under `data/digital_assets/avatars/` if not already there
4. **Document in knowledge_map.yml** with link to canonical avatar
5. **Use consistently** across all platforms

**Visual identity: Complete. Canonical. Ready to ship.**
