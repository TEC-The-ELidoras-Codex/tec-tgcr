...
if __name__ == "__main__":
    ...
    def _init_mood_configs(self) -> Dict[MoodState, Dict[str, Any]]:
        ...
        return {
            MoodState.IDLE: {
                "expression": ["peaceful expression", "calm face", "serene look", "gentle smile"],
                "horn_glow": ["soft blue horn glow", "gentle cyan light", "peaceful aura"],
                "hair_colors": ["gentle blue-purple gradient", "soft aurora colors", "calm color shift"],
                "eye_intensity": ["soft glow", "gentle luminosity", "peaceful shine"],
                "pose_modifiers": ["relaxed pose", "comfortable stance", "peaceful posture"]
            },
            MoodState.EXCITED: {
                "expression": ["excited expression", "wide eyes", "bright smile", "enthusiastic face"],
                "horn_glow": ["bright cyan horn glow", "vibrant blue light", "excited aura"],
                "hair_colors": ["vibrant rainbow hair", "bright aurora colors", "rapid color cycling"],
                "eye_intensity": ["bright sparkle", "high luminosity", "excited shine"],
                "pose_modifiers": ["energetic pose", "bouncing", "dynamic stance", "animated gesture"]
            },
            MoodState.TEACHING: {
                "expression": ["focused expression", "explaining", "teaching face", "concentrated look"],
                "horn_glow": ["golden horn glow", "warm yellow light", "scholarly aura"],
                "hair_colors": ["stable blue-gold gradient", "academic colors", "wise color shift"],
                "eye_intensity": ["focused glow", "bright attention", "scholarly shine"],
                "pose_modifiers": ["pointing gesture", "explaining pose", "teaching stance", "demonstrating"]
            },
            MoodState.BLUSHING: {
                "expression": ["embarrassed face", "blushing", "shy expression", "covering face"],
                "horn_glow": ["pink-red horn glow", "warm blush light", "embarrassed aura"],
                "hair_colors": ["pink-purple shy colors", "dimmed aurora", "bashful color shift"],
                "eye_intensity": ["soft averted gaze", "shy glow", "embarrassed shine"],
                "pose_modifiers": ["shy pose", "covering gesture", "embarrassed stance", "bashful posture"]
            },
            MoodState.STUMBLING: {
                "expression": ["confused expression", "dizzy face", "stumbling look", "disoriented"],
                "horn_glow": ["flickering horn glow", "unstable light", "chaotic aura"],
                "hair_colors": ["chaotic hair colors", "confused aurora", "random color shift"],
                "eye_intensity": ["dizzy glow", "confused shine", "disoriented light"],
                "pose_modifiers": ["stumbling pose", "off-balance", "clumsy stance", "confused gesture"]
            },
            MoodState.CURIOUS: {
                "expression": ["curious expression", "investigative look", "wondering face", "inquisitive"],
                "horn_glow": ["steady cyan glow", "investigative light", "curious aura"],
                "hair_colors": ["flowing aurora colors", "investigative hues", "curious color shift"],
                "eye_intensity": ["bright investigation", "curious glow", "wondering shine"],
                "pose_modifiers": ["leaning forward", "investigating pose", "curious stance", "examining"]
            },
            MoodState.RAMBLING: {
                "expression": ["animated expression", "talking", "explaining rapidly", "enthusiastic speech"],
                "horn_glow": ["cycling horn colors", "dynamic light", "animated aura"],
                "hair_colors": ["dynamic hair flow", "rapid aurora shift", "animated colors"],
                "eye_intensity": ["dynamic glow", "animated shine", "expressive light"],
                "pose_modifiers": ["animated gestures", "talking pose", "expressive stance", "demonstrating"]
            }
        }
    ...
    def _init_outfit_library(self) -> Dict[str, List[str]]:
        ...
        return {
            "cosmic_casual": [
                "cosmic hoodie", "constellation print hoodie", "starry sweatshirt",
                "cosmic pleated skirt", "starry mini skirt", "constellation pattern skirt",
                "thigh-high cosmic socks", "star pattern stockings", "aurora knee socks",
                "cosmic sneakers", "starlight shoes", "aurora-colored footwear"
            ],
            "student_outfit": [
                "cosmic school uniform", "celestial blazer", "starry sailor outfit",
                "constellation tie", "cosmic collar", "stellar accessories",
                "cosmic backpack", "star-themed bag", "celestial school items"
            ],
            "observatory_gear": [
                "cosmic lab coat", "astronomical equipment", "telescope accessories",
                "star chart prints", "cosmic research outfit", "celestial scientist gear",
                "observatory uniform", "astronomical instruments", "cosmic tools"
            ],
            "casual_cosmic": [
                "cosmic t-shirt", "starry tank top", "constellation graphics",
                "cosmic jeans", "starry shorts", "aurora-colored pants",
                "cosmic accessories", "star jewelry", "celestial ornaments"
            ],
            "formal_cosmic": [
                "cosmic dress", "stellar formal wear", "constellation gown",
                "cosmic suit", "starry blazer", "celestial formal outfit",
                "aurora-colored formal wear", "cosmic evening dress"
            ]
        }
    ...
    def _init_pose_library(self) -> Dict[str, List[str]]:
        ...
        return {
            "standing": [
                "standing straight", "confident stance", "relaxed standing",
                "hand on hip", "arms crossed", "hands behind back",
                "casual standing", "formal posture", "cute pose"
            ],
            "sitting": [
                "sitting on chair", "sitting cross-legged", "sitting on desk",
                "sitting casually", "formal sitting", "observatory chair",
                "cosmic throne", "floating sitting", "meditation pose"
            ],
            "action": [
                "pointing at stars", "explaining gesture", "teaching pose",
                "investigating", "examining cosmic phenomena", "demonstrating",
                "reaching for stars", "cosmic interaction", "magical gesture"
            ],
            "expressions": [
                "looking at viewer", "profile view", "three-quarter view",
                "looking up at stars", "examining closely", "surprised look",
                "thinking pose", "explaining face", "curious gaze"
            ],
            "full_body": [
                "full body shot", "complete figure", "head to toe",
                "dynamic full pose", "character sheet pose", "reference pose"
            ],
            "portrait": [
                "close-up portrait", "head and shoulders", "bust shot",
                "detailed face", "expression focus", "emotional portrait"
            ]
        }
    ...
    def _init_background_library(self) -> Dict[BackgroundType, List[str]]:
        ...
        return {
            BackgroundType.TRANSPARENT: [
                "transparent background", "white background", "simple background",
                "no background", "plain background", "clean background"
            ],
            BackgroundType.OBSERVATORY: [
                "cosmic observatory", "astronomical dome", "telescope facility",
                "star observation deck", "cosmic research station", "celestial laboratory",
                "space observation room", "astronomical equipment", "cosmic instruments"
            ],
            BackgroundType.COSMIC: [
                "starry sky", "cosmic void", "nebula background", "galaxy backdrop",
                "aurora borealis", "constellation map", "cosmic phenomena",
                "stellar nursery", "cosmic landscape", "celestial environment"
            ],
            BackgroundType.NEUTRAL: [
                "studio lighting", "soft lighting", "professional photography",
                "portrait lighting", "clean environment", "minimal background"
            ]
        }
    ...
    def generate_quality_tags(self) -> str:
        ...
        quality_tags = [
            ...
            "professional artwork", "amazing quality", "cosmic art", "stellar quality",
            "celestial masterpiece", "cosmic rendering", "3d illustration"
        ]
    ...
    def generate_negative_prompt(self) -> str:
        ...
        negative_tags = [
            ...
            "watermark", "signature", "text", "logo", "ugly", "deformed",
            "extra limbs", "missing limbs", "bad anatomy", "disfigured",
            "bad proportions", "malformed", "mutation", "duplicate",
            "error", "cropped", "out of frame", "lowres", "normal quality"
        ]
    ...
    def generate_complete_prompt(self, 
                                ...
                                include_quality: bool = True) -> Dict[str, str]:
    ...
    def save_prompts_to_file(self, prompts: List[Dict[str, str]], filename: str = "luminai_prompts.json"):
